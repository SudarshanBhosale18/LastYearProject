...
path1 = '"D:/project code/Updated 100 % code of Teeth detection/caries"'    #path of folder of images    
path2 = 'D:/project code/Updated 100 % code of Teeth detection/testing_set/1'  #path of folder to save images    
path3 = 'D:/project code/Updated 100 % code of Teeth detection/testing_set/2'
path4 = 'D:/project code/Updated 100 % code of Teeth detection/testing_set/3'
